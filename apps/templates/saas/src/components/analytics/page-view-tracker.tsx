 ...
 * sensitive query params (reset tokens, OAuth codes, etc.) never reach GA4.
 */
function PageViewTrackerInner() {
  ...
  useEffect(() => {
    if (!pathname) return;
    // Dedup key includes the query string so query-driven view changes
    // (tabs, filters, pagination) still count as a page_view, but the
    // value actually sent to GA4 below omits it entirely.
